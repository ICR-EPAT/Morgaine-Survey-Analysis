...
estimanddb3 |> tbl_summary(by = `Estimands used?`, include = `Sponsor type`) |>
  add_overall() |>
  add_n() |>
...
estimanddb4 |> tbl_summary(by = `Estimands used?`, include = `Sponsor type`) |>
  add_overall() |>
  add_n() |>
  modify_spanning_header(c("stat_1", "stat_2") ~ "**Estimands Used?**") |>
  modify_caption("**Table 1. Estimand usage by sponsor type**") |>
...
estimanddb3 |> tbl_summary(by = `Estimands used?`, include = `Sponsor country` ) |>
  add_overall() |>
  add_n() |>
  modify_spanning_header(c("stat_1", "stat_2") ~ "**Estimands Used?**") |>
...
estimanddb4 |> tbl_summary(by = `Estimands used?`, include = `Sponsor country`) |>
  add_overall() |>
  add_n() |>
  modify_spanning_header(c("stat_1", "stat_2") ~ "**Estimands Used?**") |>
  modify_caption("**Table 2. Estimand usage by sponsor country**") |>
...
estimanddb3 |> tbl_summary(by = `Estimands used?`, include = `Funding type` ) |>
  add_overall() |>
  add_n() |>
  modify_spanning_header(c("stat_1", "stat_2") ~ "**Estimands Used?**") |>
...
estimanddb4 |> tbl_summary(by = `Estimands used?`, include = `Funding type`) |>
  add_overall() |>
  add_n() |>
  modify_spanning_header(c("stat_1", "stat_2") ~ "**Estimands Used?**") |>
  modify_caption("**Table 3. Estimand usage by funding type**") |>
...
estimanddb3 |> tbl_summary(by = `Estimands used?`, include = `Trial Phase` ) |>
  add_overall() |>
  add_n() |>
  modify_spanning_header(c("stat_1", "stat_2") ~ "**Estimands Used?**") |>
...
estimanddb3 |> tbl_summary(by = `Estimands used?`, include = Int_typ_cat ) |>
  add_overall() |>
  add_n() |>
  modify_spanning_header(c("stat_1", "stat_2") ~ "**Estimands Used?**") |>
...
estimanddb3 |> tbl_summary(by = `Estimands used?`, include = `Year opened` ) |>
  add_overall() |>
  add_n() |>
  modify_spanning_header(c("stat_1", "stat_2") ~ "**Estimands Used?**") |>
