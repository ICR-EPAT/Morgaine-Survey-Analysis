...
#Recoding sponsor covariate (Missing = 0, Non-industry = 1, Industry = 2)

estimand_model_recode1$sponsor <- factor(estimand_model_recode1$sponsor, levels = c("Missing", "Non-Industry", "Industry"))
...
#Recoding funding covariate (Other = 0, Missing = 1, Non-Industry = 2, Industry=3)

estimand_model_recode1$funding <- factor(estimand_model_recode1$funding, levels = c("Other", "Missing", "Non-Industry", "Industry"))
...
estimand_model_recode1$int_model <- factor(estimand_model_recode1$int_model, levels = c("Missing", "Factorial", "Crossover", "Sequential", "Single Group", "Parallel"))
...
```{r covariate spline fitting, include=TRUE}
